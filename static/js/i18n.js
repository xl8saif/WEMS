...
(function () {
  const U = {
    ...
    'اردو کیلکولیٹر': 'Urdu Calculator', 'سائٹ وزٹرز:': 'Site visitors:', 'روزمرہ حساب کے لیے سادہ، تیز اور موبائل فرینڈلی کیلکولیٹر۔ اعداد اردو ہندسوں میں دکھائے جاتے ہیں جبکہ حساب اندرونی طور پر درست عددی فارمیٹ میں کیا جاتا ہے۔': 'A simple, fast and mobile-friendly calculator for everyday calculations. Numbers are displayed in Urdu digits while calculations use an accurate numeric format.', 'جمع، تفریق، ضرب، تقسیم اور فیصد': 'Addition, subtraction, multiplication, division and percentage', 'کی بورڈ سے بھی اعداد اور بنیادی آپریٹرز استعمال کیے جا سکتے ہیں': 'Numbers and basic operators can also be entered from the keyboard', 'AC سے مکمل حساب صاف کریں اور ⌫ سے آخری ہندسہ حذف کریں': 'Use AC to clear the calculation and ⌫ to delete the last digit', 'ڈیش بورڈ': 'Dashboard', 'کلائنٹس': 'Clients', 'کلائنٹ': 'Client',
